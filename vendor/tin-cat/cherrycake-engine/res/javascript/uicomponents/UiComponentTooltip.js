(function($){
	...
	$.UiComponentTooltip.defaults = {
		style: false,
		position: '<?= $e->UiComponentTooltip->getConfig("defaultPosition") ?>',
		isOpenOnInit: false,
		...
		ajaxUrl: false,
		ajaxSetup: false,
		isOpenDelay: <?= ($e->UiComponentTooltip->getConfig("defaultIsOpenDelay") ? "true" : "false") ?>,
		openDelay: <?= $e->UiComponentTooltip->getConfig("defaultOpenDelay") ?>,
		isCloseDelay: <?= ($e->UiComponentTooltip->getConfig("defaultIsCloseDelay") ? "true" : "false") ?>,
		closeDelay: <?= $e->UiComponentTooltip->getConfig("defaultCloseDelay") ?>,
