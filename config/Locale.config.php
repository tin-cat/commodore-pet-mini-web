...
$LocaleConfig = [
	"availableLocales" => [ // An array of possible different localizations based on the domain requested
		"main" => [
			...
			"language" => \Cherrycake\LANGUAGE_ENGLISH, // The default language
			"dateFormat" => \Cherrycake\DATE_FORMAT_MIDDLE_ENDIAN, // The default date format
			"temperatureUnits" => \Cherrycake\TEMPERATURE_UNITS_FAHRENHEIT, // The default temperature units
			"currency" => \Cherrycake\CURRENCY_EURO, // The default currency
	...
	"availableLanguages" => [\Cherrycake\LANGUAGE_ENGLISH], // An array of the languages that are available for the APP. The textsTableName should contain at least this languages.
