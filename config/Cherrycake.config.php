...
define("IS_DEVEL_ENVIRONMENT", gethostname() == "commodorepetmini.com.buzz"); // Whether the app is running in the devel environment or not.
...
const CONFIG_DIR = APP_DIR."/config"; // The directory where modules configuration files reside
const APP_MODULES_DIR = APP_DIR."/modules"; // The directory where app modules reside
const APP_CLASSES_DIR = APP_DIR."/classes"; // The directory where app classes reside
